...
#include "GrabberActorComponent.h"
#include "Engine.h"
#include "Kismet/GameplayStatics.h"

// #define OUT

UGrabberActorComponent::UGrabberActorComponent()
{
...
void UGrabberActorComponent::BeginPlay()
{
	//Super::BeginPlay();
	this->HasBegunPlay();
	World = GetWorld();
...
void UGrabberActorComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UGrabberActorComponent::FindPhysicsHandleComponent()
{
	...
	if (!PhysicsHandle) 
	{ 
		GEngine->AddOnScreenDebugMessage(-1, 5.0f, FColor::Red, "DID NOT FIND Physics Handle");
		return; 
...
void UGrabberActorComponent::FindInputComponent()
{
	...
	if (InputComponent)
	{
		InputComponent->BindAction("Grab", IE_Pressed, this, &UGrabberActorComponent::GrabObject);
		InputComponent->BindAction("Grab", IE_Released, this, &UGrabberActorComponent::ReleaseObject);
	}
	else
		UE_LOG(LogTemp, Error, TEXT("%s missing input component"), *GetOwner()->GetName())
}

FVector UGrabberActorComponent::GetLineTraceEnd()
{
...
void UGrabberActorComponent::GrabObject()
{
...
void UGrabberActorComponent::ReleaseObject()
{
...
const FHitResult UGrabberActorComponent::GetFirstPhysicsBodyInReach()
{
