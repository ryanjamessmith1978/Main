--[[
    ...
    ● Make it so that Level 1 starts with just simple flat blocks, with later levels generating the ones with patterns on them. 
        These should be worth more points.
