...
function PlayerJumpState:update(dt)
    ...
    local tileLeft = self.player.map:pointToTile(self.player.x + 2, self.player.y)
    local tileRight = self.player.map:pointToTile(self.player.x + self.player.width - 2, self.player.y)
