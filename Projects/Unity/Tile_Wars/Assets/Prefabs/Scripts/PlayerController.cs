...
public class PlayerController_2 : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        ...
        float jMoveVert = Input.GetAxis("VerticalController");
        float jMoveHorz = Input.GetAxis("HorizontalController");
        ...
        // keyboard movement
        if (Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.D) || Input.GetButton("Horizontal") || Input.GetButton("Vertical") || Input.GetAxis("VerticalController") > 0 || Input.GetAxis("HorizontalController") > 0 || Input.GetAxis("VerticalController") < 0 || Input.GetAxis("HorizontalController") < 0)
        {
       ...
       // slice
        ...
        // rotate
        if (Input.GetAxis("RotateController") < 0)
            transform.Rotate(-Vector3.up * RotateSpeed * Time.deltaTime, Space.Self);
        else if (Input.GetAxis("RotateController") > 0)
            transform.Rotate(Vector3.up * RotateSpeed * Time.deltaTime, Space.Self);
    }
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("Sword2") || other.gameObject.CompareTag("Sword3") || other.gameObject.CompareTag("Sword4"))
        {
