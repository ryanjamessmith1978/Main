...
public class World : MonoBehaviour {
	...
	public void MoveTo (Point coords) {
		...
		if (!selectedTile.occupant.IsMoving ()) {
			if(selectedTile.occupant.NavigateTo (coords)) {
				...
				CheckOccupy(selectedTile.occupant, coords);
		}
	}
    ...
    public void BuyCriticalDamage()
    {
        ...
        selectedTile.occupant.BuyCriticalDamage();
    }
    ...
    public void BuyHealth()
    {
        ...
        selectedTile.occupant.BuyHealth();
    }

	public void CheckOccupy(Unit unit, Point coords)
	 {
		Tile t = GetTileFromCoords (coords);
		...
		if (t.occupant != null) 
		{
			...
			if (unit.CanAttack (coords)) 
			{
				unit.Attack (t.occupant);
			}
