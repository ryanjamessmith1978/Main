// *** Boat Physics Math ***
// Physics math from http://www.gamasutra.com/view/news/237528/Water_interaction_model_for_boats_in_video_games.php
// Cleans up the code by including a separate file to just store all the physics equations used in the simulation
// by Ryan J Smith
...
public static class BoatPhysicsMath
{
    ...
    public static Vector3 ViscousWaterResistanceForce(float rho, TriangleData triangleData, float Cf)
    {
        ...
        //Projection of the velocity on the plane with the normal normal
